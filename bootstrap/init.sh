...
kubectl create secret generic argocd-m2-repo --namespace=argocd --type=Opaque --from-literal=url=$repository --from-literal=password=$git_api_token
kubectl label secret -n argocd argocd-m2-repo argocd.argoproj.io/secret-type=repository
